...
export const ScreenFormLayout = styled.form`
  width: 100%;
  flex-grow: 1;
...
export class ScreenForm extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        {this.props.isNotificationVisible && (
          <AlertWrapper>
            <Alert
              colorScheme={
                this.props.isNotificationSuccess ? "success" : "error"
              }
            >
        ...
        <ScreenFormLayout {...this.props}>{children}</ScreenFormLayout>
      </React.Fragment>
    );
  }
}
